...
//////// Inheritance between classes - Con functions //////////
...
///// Inheriting between classes - Object.create()
...
jay.init('Jay', 2010, 'Business Management')
jay.introduce();
jay.calcAge();
*/
...
rivian.accelerate().accelerate().brake().chargeBattery(70).accelerate().brake()
