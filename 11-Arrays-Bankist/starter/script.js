...
// Display summary - Total incomes, outcomes, and extra interest earned
const calcDisplaySummary = function (acc) {
  ...
  const interest = acc.movements
    ...
    // Bank only allows interest if the deposit is over 1
    .filter((int, i, arr) => int >= 1)
    .reduce((acc, interest) => acc + interest, 0);
  labelSumInterest.textContent = `${interest} EUR`;
};

// Create usernames using intitials of account names
...
// Only grants a loan if there is atleast one deposit with atleast 10% of the loan amount
...
//     let stage = age > 3 ? `adult` : `puppy`;
//     console.log(`Dog number ${i + 1} is a ${stage}, and is ${age} years old`);
//   });
// };
...
// // Ex. 3 - Object containing sum of deposits and withdrawals
...
// // Ex. 4 - Function to convert strings to Title Case
...
// 7. - Array of all dogs eating okay
const dogsEatingOkay = dogs.filter(checkEatingOkay);
console.log(dogsEatingOkay);

// 8. - Shallow copy of dogs array and sort by recommendedPortion in asc order
